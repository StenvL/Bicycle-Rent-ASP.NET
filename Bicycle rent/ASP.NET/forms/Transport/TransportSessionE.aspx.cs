...
namespace Bicycle_rent
{
    ...
    public partial class TransportSessionE : BaseEditForm<TransportSession>
    {
        /// <summary>
        /// Конструктор формы.
        /// </summary>
        public TransportSessionE()
            : base(TransportSession.Views.TransportSessionE)
        {
        }
        ...
        {
            get { return "~/forms/Transport/TransportSessionE.aspx"; }
        }
